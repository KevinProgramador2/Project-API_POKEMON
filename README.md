...
```
5. Executar o comando de compilação:Inicie a geração do APK na nuvem apontando para a plataforma Android e o perfil configurado:
   ```eas build -p android --profile preview```
   📌 Acompanhamento e Download: O EAS enviará o código para os servidores da Expo. Você poderá acompanhar o progresso pelo link do terminal. Ao concluir, um QR Code e um link direto serão disponibilizados para baixar e instalar o arquivo .apk no seu dispositivo Android.
...
<table>
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/nisgri">
        <img src="https://github.com/nisgri.png" width="100px;" alt="nisgri"/><br />
        <sub><b>nisgri</b></sub>
      </a>
    </td>
    <td align="center">
      <a href="https://github.com/MadowRod">
        <img src="https://github.com/MadowRod.png" width="100px;" alt="MadowRod"/><br />
        <sub><b>MadowRod</b></sub>
      </a>
    </td>
    <td align="center">
      <a href="https://github.com/RafaelSilvc">
        <img src="https://github.com/RafaelSilvc.png" width="100px;" alt="RafaelSilvc"/><br />
        <sub><b>RafaelSilvc</b></sub>
      </a>
    </td>
    <td align="center">
      <a href="https://github.com/pedroteixeira5">
        <img src="https://github.com/pedroteixeira5.png" width="100px;" alt="pedroteixeira5"/><br />
        <sub><b>pedroteixeira5</b></sub>
      </a>
    </td>
  </tr>
</table>
